...
| ◍ **Air Quality (AQHI)** | Live Air Quality Health Index at all 22 Alberta stations on the published 1–10+ scale, coloured by ECCC's health-risk bands | ECCC MSC GeoMet | 🟢 |
...
| | Cost reality |
|---|---|
| **🟢 Most layers** | **$0, no signup.** OpenSky anon, USGS, CelesTrak, adsb.lol, city CCTV, Radio Browser, GBFS, Launch Library 2, ECCC AQHI, bundled datasets. |
